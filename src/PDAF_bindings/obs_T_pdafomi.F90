...
MODULE obs_T_pdafomi
  ...
  LOGICAL :: assim_T        !< Whether to assimilate this data type
  INTEGER :: itype=4        ! Specify different type obs from init_dim_obs_all.F90
...
!!
  SUBROUTINE init_dim_obs_T(step, dim_obs)
...
! ***********************************************************
    ...
    if (dim_obs_p.gt.0) then
       ...
       !Debug
       !IF (mype_filter==0) write(*,'(a,3f8.2)') 'In obs_T_omi: x,y,z=',ocoord_p2(:,10)
...
!!
  SUBROUTINE obs_op_T(dim_p, dim_obs, state_p, ostate)
...
!!
  SUBROUTINE init_dim_obs_l_T(domain_p, step, dim_obs, dim_obs_l)
...
! **********************************************
  ...
  END SUBROUTINE init_dim_obs_l_T
...
!!
  SUBROUTINE localize_covar_T(dim_p, dim_obs, HP_p, HPH, coords_p)
...
! *************************************
  ...
  END SUBROUTINE localize_covar_T
...
! ***********************************
  ...
  END SUBROUTINE deallocate_obs_T

END MODULE obs_T_pdafomi
