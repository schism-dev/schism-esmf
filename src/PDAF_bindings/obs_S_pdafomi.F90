...
MODULE obs_S_pdafomi
  ...
  LOGICAL :: assim_S        !< Whether to assimilate this data type
  INTEGER :: itype=3        ! Specify different type obs from init_dim_obs_all.F90
...
!!
  SUBROUTINE init_dim_obs_S(step, dim_obs)
...
!!
  SUBROUTINE obs_op_S(dim_p, dim_obs, state_p, ostate)
...
!!
  SUBROUTINE init_dim_obs_l_S(domain_p, step, dim_obs, dim_obs_l)
...
! **********************************************
  ...
  END SUBROUTINE init_dim_obs_l_S
...
!!
  SUBROUTINE localize_covar_S(dim_p, dim_obs, HP_p, HPH, coords_p)
...
! *************************************
  ...
  END SUBROUTINE localize_covar_S
...
! ***********************************
  ...
  END SUBROUTINE deallocate_obs_S

END MODULE obs_S_pdafomi
