!$Id: obs_U_pdafomi.F90 912 2021-12-01 18:04:51Z lnerger $
...
MODULE obs_U_pdafomi
  ...
  LOGICAL :: assim_U        !< Whether to assimilate this data type
  INTEGER :: itype=5        ! Specify different type obs from init_dim_obs_all.F90
...
!!
  SUBROUTINE init_dim_obs_U(step, dim_obs)
...
!!
  SUBROUTINE obs_op_U(dim_p, dim_obs, state_p, ostate)
...
!!
  SUBROUTINE init_dim_obs_l_U(domain_p, step, dim_obs, dim_obs_l)
...
! **********************************************
  ...
  END SUBROUTINE init_dim_obs_l_U
...
!!
  SUBROUTINE localize_covar_U(dim_p, dim_obs, HP_p, HPH, coords_p)
...
! *************************************
  ...
  END SUBROUTINE localize_covar_U
...
! ***********************************
  ...
  END SUBROUTINE deallocate_obs_U

END MODULE obs_U_pdafomi
